...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderTable() {
    ...
    let html = '';
    paginated.forEach(p => {
      const imgUrl = (p.photo.startsWith('http') || p.photo.includes('/')) ? p.photo : (p.photo.startsWith('photo-') ? `https://images.unsplash.com/${p.photo}?w=80&h=80&fit=crop&auto=format` : `https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=80&h=80&fit=crop&auto=format`);
