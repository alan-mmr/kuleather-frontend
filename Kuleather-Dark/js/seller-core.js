...
(function() {
  if (localStorage.getItem('kuleather_admin_theme') === 'light') {
    ...
    const sellerIndex = currentPath.indexOf('/Kuleather-Dark/');
    if (sellerIndex !== -1) {
      const relativePath = currentPath.substring(sellerIndex + '/Kuleather-Dark/'.length);
      window.location.replace(currentPath.substring(0, sellerIndex) + '/Kuleather-Light/' + relativePath + window.location.search);
    }
  }
})();

// ==========================================================================
// 🏪 Kuleather Dark — Core Seller Engine
// ==========================================================================
...
window.sellerSwitchTheme = function() {
  ...
  const newPath = currentPath.substring(0, sellerIndex) + '/Kuleather-Light/' + relativePath;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (themeToggleContainer) {
    themeToggleContainer.innerHTML = `
      <button class="admin-topbar-btn admin-theme-toggle-btn" id="admin-theme-btn" onclick="sellerSwitchTheme()" aria-label="Ganti ke Mode Terang" title="Ganti ke Mode Terang" style="margin-right: 8px;">
    ...
    const defaultOrders = [
      {
        ...
        status: "Selesai",
        items: [
          { id: "card-holder", name: "Card Holder Kulit Slim Minimalis", price: 185000, qty: 1, variant: "Tan Natural", photo: "photo-1584917865442-de89df76afd3" }
        ]
      },
      {
        id: "ORD-20260405-021",
        ...
        status: "Selesai",
        items: [
          { id: "sabuk-pullup", name: "Sabuk Pull-Up Leather Artisan", price: 275000, qty: 2, variant: "Cokelat Tua", photo: "photo-1553062407-98eeb64c6a62" }
        ]
      },
      {
        id: "ORD-20260510-044",
        ...
        status: "Selesai",
        items: [
          { id: "dompet-bifold", name: "Dompet Bifold Kulit Sapi Premium", price: 350000, qty: 1, variant: "Hitam Matte", photo: "photo-1614252369475-531eba835eb1" }
        ]
      },
      {
        id: "ORD-20260601-098",
        ...
        status: "Selesai",
        items: [
          { id: "tote-full-grain", name: "Tas Tote Kulit Full Grain Magetan", price: 1250000, qty: 1, variant: "Cokelat Tua", photo: "photo-1548036328-c9fa89d128fa" }
        ]
      },
      {
        id: "ORD-20260618-105",
        ...
        status: "Diproses",
        items: [
          { id: "dompet-bifold", name: "Dompet Bifold Kulit Sapi Premium", price: 350000, qty: 2, variant: "Hitam Matte", photo: "photo-1614252369475-531eba835eb1" }
        ]
      },
      {
        id: "ORD-20260620-112",
        ...
        items: [
          { id: "sabuk-pullup", name: "Sabuk Pull-Up Leather Artisan", price: 275000, qty: 1, variant: "Tan Natural", photo: "photo-1553062407-98eeb64c6a62" }
        ]
      }
    ];
    ...
    const defaultServiceOrders = [
      {
        ...
        chat: [
          ...
          { sender: "seller", name: "Toko Pak Slamet", time: "10 Mei 2026, 10:30", message: "Halo! Siap, saya punya stok kulit domba pilihan. Untuk ukuran L estimasi 14 hari kerja. Harga Rp2.200.000 sudah termasuk ongkir. Oke?", isRead: true },
          ...
          { sender: "seller", name: "Toko Pak Slamet", time: "11 Mei 2026, 08:00", message: "DP sudah masuk, terima kasih! Saya mulai proses hari ini.", isRead: true },
      ...
      },
      {
        ...
        chat: [
          ...
          { sender: "seller", name: "Toko Pak Slamet", time: "02 Mei 2026, 13:20", message: "Penawaran: Full grain Tan Natural, 8 card slot + 1 zipper pocket. Harga Rp620.000 all-in. Estimasi 10 hari kerja 🙏", isRead: true },
      ...
      },
      {
        ...
        chat: [
          ...
          { sender: "buyer", name: "Budi Santoso", time: "18 Apr 2026, 16:30", message: "Wah bagus banget pak!! Makasih banyak ya 🙏⭐⭐⭐⭐⭐", isRead: true }
        ]
      }
    ];
