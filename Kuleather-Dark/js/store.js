...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderProducts() {
    ...
    state.filteredProducts.forEach(p => {
      ...
      const imgUrl = p.photo.startsWith('http') ? p.photo : `https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop&auto=format`;
  ...
  function renderServicesList(servicesToRender) {
    ...
    servicesToRender.forEach(s => {
      const imgUrl = s.portfolio && s.portfolio.startsWith('http') ? s.portfolio : `https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=300&fit=crop&auto=format`;
      html += `
